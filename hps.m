function f = hps(audio, Fs, note_index)
    ...
    % Get peaks that is higher than threshold and remove peak that is close to
    % max peak
    ...
    % Make sure the amount of times downsampling isn't too much
    ...
    for i = 2:max_downsample
        ...
        downsampled_spectrum = [downsampled_spectrum; zeros(length(hps_spectrum) - length(downsampled_spectrum), 1)];
