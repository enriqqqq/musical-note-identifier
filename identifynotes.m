...
function notes = identifynotes(freqs)
    ...
    for i=1:len
        ...
        elseif curr_freq >= 16.835 && curr_freq < 17.835
            note = 'C#';
        elseif curr_freq >= 17.835 && curr_freq < 18.9
            note = 'D';
        elseif curr_freq >= 18.9   && curr_freq < 20.025
            note = 'D#';
        elseif curr_freq >= 20.025 && curr_freq < 21.215
            note = 'E';
        elseif curr_freq >= 21.215 && curr_freq < 22.475
            note = 'F';
        elseif curr_freq >= 22.475 && curr_freq < 23.81
            note = 'F#';
        elseif curr_freq >= 23.81  && curr_freq < 25.23
            note = 'G';
        elseif curr_freq >= 25.23  && curr_freq < 26.73
            note = 'G#';
